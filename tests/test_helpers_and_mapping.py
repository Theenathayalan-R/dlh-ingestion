...
from dlh_run_db_ingestion import sanitize_column_name, map_data_types, fetch_data_from_oracle
...
class TestHelpersAndMapping(unittest.TestCase):
    ...
    def test_sanitize_various(self):
        ...
        self.assertEqual(sanitize_column_name("A-B/C"), "A_B_C")
        self.assertEqual(sanitize_column_name("__x__ y__"), "x_y")
    ...
    @patch("dlh_run_db_ingestion.read_from_jdbc")
